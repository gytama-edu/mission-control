...
export default function App() {
  ...
  const [activeClassId, _setActiveClassId] = useState<string | null>(() => {
    try {
      return window.localStorage.getItem('mission_control_active_class');
    } catch {
      return null;
    }
  });
  ...
  const setActiveClassId = (id: string | null) => {
    ...
    try {
      if (id) {
        ...
        window.localStorage.removeItem('mission_control_active_class');
      }
    } catch (e) {
      console.error(e);
    }
